  ...
  ({ record, index }, ref) => {
    ...
    return (
      <motion.div
        ...
        className="h-full"
      >
        <Card className="h-full flex flex-col overflow-hidden border-white/10 dark:border-white/5 bg-card/40 backdrop-blur-md hover:border-amber-500/40 hover:shadow-2xl transition-all duration-300 group/card">
